...
EXEC_MOUNTS=""
REQUIRED_RW="/data"
ENV_REPORT="PORT BASE_PATH TRUST_PROXY ADMIN_USERNAME ADMIN_PASSWORD JWT_SECRET LOG_TO_FILE GIFS_PUBLIC_CATEGORY GIFS_DEFAULT_CATEGORY_ID GIFS_ALLOWED_DOMAINS DISCORD_BOT_TOKEN DISCORD_ALLOWED_USER_IDS DISCORD_CHANNEL_IDS DISCORD_PUBLIC_ORIGIN"
ENV_SECRET="ADMIN_PASSWORD JWT_SECRET DISCORD_BOT_TOKEN"
